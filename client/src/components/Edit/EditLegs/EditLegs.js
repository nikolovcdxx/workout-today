...
export default function EditPush({ ...exercises }) {
    const [quadriceps1, setQuadriceps1] = useState(exercises['quadriceps1']);
    const [quadriceps2, setQuadriceps2] = useState(exercises['quadriceps2']);
    const [hamstrings, setHamstrings] = useState(exercises['hamstrings']);
    const [glutes1, setGlutes1] = useState(exercises['glutes1']);
    const [glutes2, setGlutes2] = useState(exercises['glutes2']);
    const [calves, setCalves] = useState(exercises['calves']);
